...
export const adminApi = {
  ...
  getInventory: (params = {}) => {
    ...
    return api(`/api/admin/inventory${q ? `?${q}` : ""}`);
  },
  setInventory: (id, body) =>
    api(`/api/admin/inventory/${id}`, { method: "PUT", body }),
  adjustInventory: (id, delta, extra = {}) =>
    api(`/api/admin/inventory/${id}/adjust`, {
      method: "POST",
      body: { delta, ...extra },
    }),
};
